...
if (isset($_FILES['upload_adminImg'])) {
    ...
    if ($_FILES['upload_adminImg'] && $_FILES['upload_adminImg']['size'] > 0) {
        // store img
        $imgUpload = $_FILES['upload_adminImg'];
        // print_r($imgUpload);

        // save img
        $img = writeUserImg($folder_adminImgs, $imgUpload);
            ...
            <div class="card">
                <div class="card-body">
                                    ...
                                    <div class="form-group file-upload">
                                        <form action="admin-profile.php" method="post" enctype="multipart/form-data">
                                            <div class="img-change-wrap">
                                                ...
                                                <input type="file" accept=".png, .jpg, .jpeg" class="input-file" name="upload_adminImg" onchange="this.form.submit()" />
                    ...
                    <div class="forms">
                        ...
                        <!-- USER DATA -->
                        <form class="form-data" action="admin-profile.php" method="post" enctype="multipart/form-data">
